...
static Binding keydown_bindings_mousepaint_m[] = {
    ...
    { XKB_KEY_Return,	WLR_MODIFIER_SHIFT,	mp_save_frame,			},
    { XKB_KEY_KP_Enter,	WLR_MODIFIER_SHIFT,	mp_save_frame,			},
...
static Binding keydown_bindings_variables_m[] = {
    ...
    { XKB_KEY_V,	WLR_MODIFIER_ALT|WLR_MODIFIER_SHIFT,	pending_var_dec, },
    { XKB_KEY_Down,	0,					pending_var_inc, },
    { XKB_KEY_v,	WLR_MODIFIER_ALT,			pending_var_inc, },
...
static Binding keydown_bindings_colormaps_m[] = {
    ...
    { XKB_KEY_C,	WLR_MODIFIER_ALT|WLR_MODIFIER_SHIFT,	pending_map_dec,	},
    { XKB_KEY_Down,	0,					pending_map_inc,	},
    { XKB_KEY_c,	WLR_MODIFIER_ALT,			pending_map_inc,	},
...
static Binding keydown_bindings[] = {
    ...
    { XKB_KEY_V,		WLR_MODIFIER_SHIFT,		var_ichange,	{.i=-1}			}, // Previous variable.
    { XKB_KEY_v,		WLR_MODIFIER_ALT,		set_prog_mode,	{.i=variables_m}	}, // see keydown_bindings_variables_m for info
    ...
    { XKB_KEY_exclam,		WLR_MODIFIER_SHIFT,		shift_max,	{.f=-0.02}		}, // make the largest value smaller
    { XKB_KEY_2,		0,			shift_min,	{.f=0.02}		}, // make the smallest value larger
    { XKB_KEY_quotedbl,		WLR_MODIFIER_SHIFT,		shift_max,	{.f=0.02}		}, // make the largest value larger
    ...
    { XKB_KEY_1,		WLR_MODIFIER_ALT,		shift_min_abs,	{.f=-0.02}		},
    ...
    { XKB_KEY_c,		WLR_MODIFIER_ALT,		toggle_var,	{.v=&globs.invert_c}	}, // Invert (reverse) the colormap.
    { XKB_KEY_C,		WLR_MODIFIER_SHIFT|WLR_MODIFIER_ALT,	set_prog_mode,	{.i=colormaps_m}	}, // see keydown_bindings_colormaps_m
    /* Swap foreground and background colors. */
    { XKB_KEY_I,		WLR_MODIFIER_SHIFT,		invert_colors,				},
    ...
    { XKB_KEY_E,		WLR_MODIFIER_SHIFT,		toggle_var,	{.v=&globs.exact}	},
    ...
    { XKB_KEY_space,	WLR_MODIFIER_SHIFT,		toggle_var,	{.v=&play_inv}		},
    ...
    { XKB_KEY_N,		WLR_MODIFIER_SHIFT,		toggle_var,	{.v=&globs.usenan}	},
    ...
    { XKB_KEY_Right,	WLR_MODIFIER_ALT,		inc_offset_i,	{.i=7}			},
    { XKB_KEY_Left,	WLR_MODIFIER_ALT,		inc_offset_i,	{.i=-7}			},
    { XKB_KEY_Up,		WLR_MODIFIER_ALT,		inc_offset_j,	{.i=-7}			},
    { XKB_KEY_Down,	WLR_MODIFIER_ALT,		inc_offset_j,	{.i=7}			},
    { XKB_KEY_Up,		0,			inc_offset_j,	{.i=-7}			},
    { XKB_KEY_Down,	0,			inc_offset_j,	{.i=7}			},
    /* Move the zoom/view rectangle 1 step. */
    { XKB_KEY_Right,	WLR_MODIFIER_SHIFT|WLR_MODIFIER_ALT,	inc_offset_i,	{.i=1}			},
    { XKB_KEY_Left,	WLR_MODIFIER_SHIFT|WLR_MODIFIER_ALT,	inc_offset_i,	{.i=-1}			},
    { XKB_KEY_Up,		WLR_MODIFIER_SHIFT|WLR_MODIFIER_ALT,	inc_offset_j,	{.i=-1}			},
    { XKB_KEY_Down,	WLR_MODIFIER_SHIFT|WLR_MODIFIER_ALT,	inc_offset_j,	{.i=1}			},
    ...
    { XKB_KEY_T,		WLR_MODIFIER_SHIFT,		ask_crs,				},
#ifdef HAVE_PNG
    { XKB_KEY_s,		WLR_MODIFIER_CTRL,		save_png,				},
#endif
#ifdef HAVE_NCTPROJ
